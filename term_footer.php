    ...
    <div class="row">
      ...
      <div class="col-12 col-sm-12 col-md-4 col-lg-5 col-xl-4">
        <div class="footer-box footer-contact-form">
            <p class="white">For any questions about these Terms, please contact us at:  DallSupplements.com</p>
        ...
        <h3 class="footer-title vigo-send-message pos-r white">
          ...
          <form>
            ...
            <p class="white " style="margin-top: 10px">
            This Terms of Service is tailored for your fitness supplement store and website. However, I recommend having it reviewed 
            by a legal professional to ensure it complies with all applicable laws and regulations, particularly those specific to
